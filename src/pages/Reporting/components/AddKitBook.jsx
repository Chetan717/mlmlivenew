...
export default function AddKitBook({ memberProfile }) {
  ...
  useEffect(() => {
    ...
    const fetchPlans = async () => {
      try {
        ...
        // Fetch all SP Closed entries to get closed plan IDs
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await wb.commit();
      toast.success(`${batch.length} kit book(s) submitted`);
      setBatch([]);
      setOpen(false);
    } catch {
  ...
  return (
    <SectionCard
      ...
      title="Add Kit Book"
      subtitle="Record kit book sales"
      count={batch.length}
      open={open}
      setOpen={setOpen}
    >
